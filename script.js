 ...
 var cities = [
  { name: 'Nehalem Basin', coordinates: [-123.9303, 45.7195], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/nehalem.jpg', description: 'Tokyo, Japan’s busy capital, mixes the ultramodern and the traditional, from neon-lit skyscrapers to historic temples.', title: 'Protecting Coho Salmon in the Nehalem Watershed', zoomLevel: 12 },
  { name: 'Tallahassee', coordinates: [-84.2807, 30.4383], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/ppgis.jpg', description: 'Delhi, India’s capital territory, is a massive metropolitan area in the country’s north.', title: 'Application Development for Public Input', zoomLevel: 12 },
  { name: 'Lake Oswego', coordinates: [-122.6706, 45.4207], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/lakeoswego.jpg', description: 'Shanghai, on China’s central coast, is the country’s biggest city and a global financial hub.', title: 'Oregon White Oaks in Lake Oswego', zoomLevel: 12 },
  { name: 'PCC Rock Creek', coordinates: [-122.8405, 45.5582], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/pccrockcreek.jpg', description: 'São Paulo, Brazil’s vibrant financial center, is among the world’s most populous cities, with numerous cultural institutions and a rich architectural tradition.', title: 'Drone Mapping of PCC Rock Creek Learning Garden', zoomLevel: 12 },
  { name: 'Northern Oregon Coast', coordinates: [-123.9625, 45.5231], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/5.jpg', description: 'Mumbai (formerly called Bombay) is a densely populated city on India’s west coast. A financial center, it\'s India\'s largest city.', title: 'Wildlife Injuries in the North Coast', zoomLevel: 12 },
  { name: 'Monterey Bay', coordinates: [-121.8947, 36.6002], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/6.jpg', description: 'Beijing, China’s sprawling capital, has history stretching back 3 millennia. Yet it’s known as much for modern architecture as its ancient sites.', title: 'Potential Dive Sites in the Monterey Bay Area', zoomLevel: 12 },
  { name: 'Chiricahua Mountains', coordinates: [-109.3425, 31.9452], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/7.jpg', description: 'Cairo, Egypt’s sprawling capital, is set on the Nile River. At its heart is Tahrir Square and the vast Egyptian Museum.', title: 'Fauntastic Chiricahua Mountains', zoomLevel: 12 },
  { name: 'Taiwan', coordinates: [120.9605, 23.6978], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/8.jpg', description: 'Dhaka, the capital of Bangladesh, is the country’s largest city. The city’s vibrant culture is reflected in its numerous festivals and lively street life.', title: 'Slowing Down the Inevitable', zoomLevel: 12 },
  { name: 'Europe', coordinates: [14.5058, 46.0569], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/europe.jpg', description: 'Mexico City is the densely populated, high-altitude capital of Mexico. It’s known for its Templo Mayor, a 13th-century Aztec temple.', title: 'European Security Alert Summary', zoomLevel: 12 },
  { name: 'Global', coordinates: [0, 0], imageUrl: 'https://yahnjr.github.io/map-portfolio/blob/main/pictures/10.jpg', description: 'Osaka is a large port city and commercial center on the Japanese island of Honshu. It’s known for modern architecture, nightlife, and hearty street food.', title: 'Global Trust in Health Infographic', zoomLevel: 2 }
];
